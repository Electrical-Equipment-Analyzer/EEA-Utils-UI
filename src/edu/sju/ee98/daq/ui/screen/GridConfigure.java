 ...
 * @author Leo
 */
public class GridConfigure extends JPanel {
    ...
    public GridConfigure() {
    }

    public GridConfigure(int x, int y, int height, int width, int verticalGraduation, int horizontalGraduation, int hardGraduation) {
        this.x = x;
        this.y = y;
        this.height = height;
        this.width = width;
