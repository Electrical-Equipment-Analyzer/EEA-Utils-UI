 ...
 * @author Leo
 */
public class BodePlotPanel extends ChartPanel {

    private BodePlotPanel(JFreeChart chart) {
        super(chart);
    ...
    public static BodePlotPanel createMagnitudePhase(Map<Double, Complex> gain) {
        ...
        return new BodePlotPanel(chart);
    }

    public static BodePlotPanel createDiffMagnitude(Map<Double, Complex> gain1, Map<Double, Complex> gain2) {
        Font font = new Font(Font.DIALOG, Font.BOLD, 14);
        Color color1 = Color.RED;
        Color color2 = Color.BLUE;
