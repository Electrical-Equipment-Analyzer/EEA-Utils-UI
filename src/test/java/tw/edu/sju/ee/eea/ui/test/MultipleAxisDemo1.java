...
package tw.edu.sju.ee.eea.ui.test;
...
public class MultipleAxisDemo1 extends ApplicationFrame {
    ...
    private static JFreeChart createChart() {
        ...
        XYDataset dataset3 = createDataset(
            "Series 3", 10000.0, new Minute(), 170
        );
    ...
    public static void main(String[] args) {
        MultipleAxisDemo1 multipleAxisDemo1 = new MultipleAxisDemo1("sss");
        multipleAxisDemo1.setVisible(true);
//        CairoImage image = new CairoImage(600, 270);
//        Graphics2D g2 = image.createGraphics2D();
//        chart.draw(g2, new Rectangle2D.Double(0.0, 0.0, 600.0, 270.0));
//        image.saveToPNG(new File("MultipleAxisDemo1.png"));
    }
